...
public class Dog {
    ...
    public String generateName() {
        String[] Beginning = { "Va", "Le", "Ra", "Mrok", "Cru", "Sos", "Ig", "Pas", "Az" };
        String[] Middle = { "the", "loh", "kaz", "mraz", "buch", "lu", "ga", "ra", "shiv" };
        String[] End = { "ev", "ov", "ey", "is", "es", "pin", "agg", "to", "fang", "va", "im" };
